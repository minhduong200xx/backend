...
const SearchSection: React.FC = () => {
  ...
  return (
    <div className="text-center h-auto flex flex-row gap-4 p-4 pt-0 mb-4 justify-center items-center">
      <div
        className="h-60 w-60"
        style={{
      ...
      ></div>
      <span className="border-2 border-blue-600 rounded-full shadow-2xl p-8 mx-5 flex flex-col gap-3">
